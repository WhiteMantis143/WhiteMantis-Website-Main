...
import styles from "./SubscriptionPopupDrip.module.css";

const SubscriptionPopupDrip = ({
  open,
  onClose,
  subscriptionProduct,
  frequencies = [],
  ...
  return (
    <div className={styles.Overlay}>
     <div className={styles.Popup} ref={popupRef}>
        ...
        <h2 className={styles.Title}>COFFEE DripBags SUBSCRIPTION</h2>
...
export default SubscriptionPopupDrip;
